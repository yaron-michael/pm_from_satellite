...
netcdf_to_loop = ['D:/test/h20v05/h20v05AOT.nc']#netcdf are tile
csv_file = ["Ws","Temp","RH"]#var of csv file
##parameters
...
for nc in netcdf_to_loop:
  ...
  # print(nc_id)
   ...
   ds = xr.open_mfdataset(full_name_with_Dir, combine='by_coords')
   ...
   if len(df_m) == 0:
    ...
    x = pd.date_range(start='2000-01-01 00:00:00', end='2022-01-01 00:00:00', freq='30min')#len of date is 385728\
        #Length of values (385729) does not match length of index (385728)
    x= x[0:len(df_main)]# to fix   # x= x[0:385728] old
    ...
    ds = xr.open_mfdataset('D:/test/h20v05/testx.nc')
    ...
    output_file_netcdf_name_and_dir = output_file_netcdf_dir +"000_"+nc_id+name_of_var[0]+ ".nc"
