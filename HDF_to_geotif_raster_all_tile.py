...
#parameters
#hdf_id dir
geo_tif_loc_to_save_in_dir_for_each_hdf_id = 'D:/test_hdf_output/' #OUTPUT
hdf_id_list =["h20v05","h21v05","h21v06"]
dir_of_hdf_file = 'D:/test_hdf4/'
#clip_shp_file = 'C:/PM2_5/REDY/shp2.shp'#use shp of all iseral to test
clip_shp_file = 'C:/PM2_5/REDY/AOT_ISERAL_ALL_2039b.shp'#use shp of all iseral to test
