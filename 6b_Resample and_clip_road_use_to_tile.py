...
geotif_land_use = ['C:/land_use_and_road/temp/P_major_road.tif','C:/land_use_and_road/temp/P_railroads.tif','C:/land_use_and_road/temp/P_highways.tif','C:/land_use_and_road/temp/total_road_density_raster_zone.tif']
...
for tile, tile_grid in zip(tile_list_shp, geotif_of_tile):
    ...
    ds.to_netcdf(output_dir+tile_name+"_road_data.nc")
